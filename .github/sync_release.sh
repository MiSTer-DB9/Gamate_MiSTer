...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Gamate_MiSTer.git"
CORE_NAME=(Gamate)
...
UPSTREAM_CORE_NAME=(Gamate)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Gamate.qpf)
COMPILATION_OUTPUT=(output_files/Gamate.rbf)
